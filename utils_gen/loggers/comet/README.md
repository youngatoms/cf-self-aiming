...
```shell
python utils_gen/loggers/comet/hpo.py \
...
```shell
comet optimizer -j <set number of workers> utils_gen/loggers/comet/hpo.py \
  utils_gen/loggers/comet/optimizer_config.json"
```
